    ...
    switch (predicate.tag) {
        ...
        case 2: {
            ...
            switch (matchResult) {
                ...
                case 4:
                    return ["true", new Fidelity(1, ["Complex range bounds not fully implemented in Swift"])];
                case 5:
                    return ["value.isSignalingNaN == false", new Fidelity(1, ["Int range check"])];
                case 6:
                ...
                case 10:
                    return ["true", new Fidelity(1, ["Complex string range bounds not fully implemented in Swift"])];
                case 11:
                ...
                case 15:
                    return ["true", new Fidelity(2, ["PrimaryKey concept does not exist in Swift validators"])];
                case 16:
...
export function emitValidator(name, predicate, isNullable) {
    ...
    return [`func validate_${name}(value: Any?) -> Bool {${isNullable ? "\n    if value == nil { return true }" : ""}
